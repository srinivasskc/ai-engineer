...
class Review(TypedDict):
    ...
    sentiment: Annotated[
        Literal["pos", "neg"],
        "Return sentiment of the review - either positive or negative or neutral",
    ]
    pros: Annotated[Optional[list[str]], "Write down all the pros inside in a list"]
    cons: Annotated[Optional[list[str]], "Write down all the cons inside in a list"]
